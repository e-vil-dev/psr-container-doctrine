...
final class ConfigurationFactoryTest extends TestCase
{
    ...
    public function testWillSetSchemaAssetsFilterByCallable(): void
    {
        $testFilter = static fn (): bool => true;
        $config     = [
            'doctrine' => [
                'configuration' => [
                    'orm_default' => ['schema_assets_filter' => $testFilter],
                ],
            ],
        ];
    ...
    public function testMistypeInSchemaAssetsFilterCallable(): void
    {
        $testFilter = ['misconfig' => 'incorrect callable'];
        $config     = [
            'doctrine' => [
                'configuration' => [
                    'orm_default' => ['schema_assets_filter' => $testFilter],
